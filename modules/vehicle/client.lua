...
function cfx.vehicle.getProperties(vehicle)
  ...
  return {
    ...
    plate = cfx.math.trim(GetVehicleNumberPlateText(vehicle)),
    plateIndex = GetVehicleNumberPlateTextIndex(vehicle),

    bodyHealth = cfx.math.round(GetVehicleBodyHealth(vehicle), 1),
    engineHealth = cfx.math.round(GetVehicleEngineHealth(vehicle), 1),
    tankHealth = cfx.math.round(GetVehiclePetrolTankHealth(vehicle), 1),

    fuelLevel = cfx.math.round(GetVehicleFuelLevel(vehicle), 1),
    dirtLevel = cfx.math.round(GetVehicleDirtLevel(vehicle), 1),
